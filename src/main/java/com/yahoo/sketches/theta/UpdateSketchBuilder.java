...
public class UpdateSketchBuilder {
	 ...
	 * <ul>
	 * <li>Nominal Entries:
	 * {@value com.yahoo.sketches.Util#DEFAULT_NOMINAL_ENTRIES}</li>
	 ...
	 * {@link ResizeFactor#X8}. For direct sketches, which are targeted for native
	 * memory off the Java heap, this value will be fixed at either
	 * {@link ResizeFactor#X1} or {@link ResizeFactor#X2}.</li>
	...
	/**
	 * Sets the Nominal Entries for this sketch. The minimum value is 16 and the
	 * maximum value is 67,108,864, which is 2^26. Be aware that sketches as large
	 * as this maximum value have not been thoroughly tested or characterized for
	 * performance.
	 * 
	 * @param nomEntries
	 *            <a href="{@docRoot}/resources/dictionary.html#nomEntries">Nominal
	 *            Entres</a> This will become the ceiling power of 2 if it is not.
	 ...
	 * 
	 * @param p
	 *            <a href="{@docRoot}/resources/dictionary.html#p">See Sampling
	 *            Probability, <i>p</i></a>
	 * @return this UpdateSketchBuilder
	 */
	 ...
	 * 
	 * @param rf
	 *            <a href="{@docRoot}/resources/dictionary.html#resizeFactor">See
	 *            Resize Factor</a>
	 * @return this UpdateSketchBuilder
	 */
	...
	/**
	 * Returns an UpdateSketch with the current configuration of this Builder with
	 * the specified backing destination Memory store. Note: this cannot be used
	 * with the Alpha Family of sketches.
	 * 
	 * @param dstMem
	...
	public UpdateSketch build(final WritableMemory dstMem) {
		...
		case MWMR_QUICKSELECT: {
			sketch = new MWMRHeapQuickSelectSketch(bLgNomLongs, bSeed, bP, bRF,
					Family.MWMR_QUICKSELECT.getMinPreLongs(), Family.MWMR_QUICKSELECT);
			break;
		}
		default: {
	...
	public String toString() {
		...
		sb.append("UpdateSketchBuilder configuration:").append(LS).append("LgK:").append(TAB).append(bLgNomLongs)
				.append(LS).append("K:").append(TAB).append(1 << bLgNomLongs).append(LS).append("Seed:").append(TAB)
				.append(bSeed).append(LS).append("p:").append(TAB).append(bP).append(LS).append("ResizeFactor:")
				.append(TAB).append(bRF).append(LS).append("Family:").append(TAB).append(bFam).append(LS);
		return sb.toString();
	}
