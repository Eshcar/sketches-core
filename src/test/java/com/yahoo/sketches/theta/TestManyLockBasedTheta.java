...
public class TestManyLockBasedTheta {
	
	public final Log LOG = LogFactory.getLog(TestManyLockBasedTheta.class);
	public Logger logger = Logger.getLogger("MyLog");
	public FileHandler fh;

	private LockBasedHeapQuickSelectSketch[] skArray_;

	public TestManyLockBasedTheta(int sketches) {
		
		skArray_ = new LockBasedHeapQuickSelectSketch[sketches];

//		UpdateSketchBuilder usb = new UpdateSketchBuilder();
//		usb.setFamily(Family.MWMR_QUICKSELECT);

		for (int i = 0; i < sketches; i++) {
			skArray_[i] = new LockBasedHeapQuickSelectSketch();
		}
	...
	public static void main(String[] args) throws Exception {
		...
		TestManyLockBasedTheta test = new TestManyLockBasedTheta(numOfSketches);
...
//			gen_  = new ScrambledZipfianGenerator(sketches);
		...
		public void doWork() throws Exception {
			...
			LockBasedHeapQuickSelectSketch sk = skArray_[accessPattarn_[index_]];
